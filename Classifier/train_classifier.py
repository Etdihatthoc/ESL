...
def parse_args():
    ...
    parser.add_argument('--model_save_path', type=str, default='./models/esl_binary_classifier_no_label_smoothing.pth',
...
def main():
    ...
    logger = setup_logging(
        ...
        experiment_name='esl_binary_classifier_no_label_smoothing'
    )
...
def inference_example():
    ...
    model_path = './models/esl_binary_classifier_no_label_smoothing.pth'
    device = get_best_device()
