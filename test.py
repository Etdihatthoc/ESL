...
class ESLDatasetWithAudio(Dataset):
    def __init__(self, dataframe, audio_processor=None, remove_low_content=True, num_chunks=10, chunk_length_sec=30):
        ...
        # Audio paths
        dataframe['absolute_path'] = dataframe['absolute_path'].str.replace("/mnt/son_usb/DATA_Vocal","/home/user01/aiotlab/sondinh/DATA_Vocal")
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if val_mae < best_val_mae:
                ...
                checkpoint_path = "./model/model_with_audio_bestmae_pretrainedAudioEncoder2.pth"  # THAY ĐỔI DÒNG NÀY
...
if __name__ == "__main__":
    ...
    log_file = f"{log_dir}/training_pretrainedAudioEncoder2.log"
    ...
    model = ESLGradingModelWithAudio.load("/home/user01/aiotlab/sondinh/DMK/ESL-Grading/model/model_with_audio_bestmae_pretrainedAudioEncoder.pth").to(device)
    # ====================
    # Load pretrained Wav2Vec2 encoder
    # checkpoint_path = "/home/user01/aiotlab/sondinh/DMK/ESL-Grading/model/ckpt_SWA_pronunciation_wav2vec2model.pth"
    # try:
    #     # Load checkpoint
    ...
    batch_size = 24  # Reduced due to audio memory requirements
    epochs = 25
    ...
    #trainer.train()
    trainer.test()
    #trainer.model.save("./model/model_with_audio_final_pretrainedAudioEncoder2.pth")
    #wandb.finish()